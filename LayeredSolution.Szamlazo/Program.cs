...
namespace LayeredSolution.Szamlazo
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            builder.RegisterType<EmployeeListViewModel>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<EmployeeListForm>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<EmployeeEditViewModel>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<EmployeeEditForm>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<NewOrderForm>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<NewOrderViewModel>().AsSelf().InstancePerLifetimeScope();
